...
```{r}
glm(y ~ Safety.Score + Average.Student.Attendance + ISAT.Exceeding.Reading.. + College.Enrollment..number.of.students., data = numeric.data1, family = binomial)
```
