...
PCA.cps <- prcomp(data.progress[2:10], center = TRUE, scale. = TRUE, rank = 3)
...
*PC1 emphasizes test scores, environment scores, and student attendance
*PC2 emphasizes Instruction Socre, Environment Score, test scores, and student attendance
