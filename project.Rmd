...
for(n in names(numeric.data)) {
  ...
  transformed.data[,paste(n, "cubed")] <- I(transformed.data[,n]^3)
  transformed.data[,paste(n, "fourth power")] <- I(transformed.data[,n]^4)
}
...
ggplot(data) +
  geom_point(aes(x= Test_Value, y = Prediction_Error), color = "blue4", size = 2) +
  geom_hline(yintercept = 0, color ="red", size = 1) +
  ggtitle("Prediction Errors With CV")
